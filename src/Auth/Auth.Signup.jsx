          ...
          <div className="relative items-center justify-center flex-1 hidden h-screen bg-gray-900 lg:flex">
              <div className="relative z-10 w-full max-w-md">
                  ...
                  <div className="mt-16 space-y-3 ">
                      <h3 className="text-3xl font-bold text-white">Start Exploring Now</h3>
                      <p className="text-gray-300">
                          Create an account and get access to all features of It's RGPV, No credit card required.
                      </p>
              ...
              <div className="max-w-md p-10 rounded-xl space-y-8 border text-white  bg-white/10 w-[600px] sm:px-10 ">
                  <div className="">
                      ...
                      <div className="mt-5 space-y-2">
                          <h3 className="text-2xl font-bold text-white sm:text-3xl">Sign up</h3>
