        ...
        <main className="flex w-full">
            <div className="relative items-center justify-center flex-1 hidden h-screen bg-gray-900 lg:flex">
                <div className="relative z-10 w-full max-w-md">
                    <img src="/src/assets/itsrgpv.jpg" className="rounded-lg" width={150} />
                    <div className="mt-16 space-y-3 ">
                        <h3 className="text-3xl font-bold text-white">Thanks for Revisit</h3>
                        <p className="text-gray-300">
                            Login and get access to all features of It's RGPV, No credit card required.
                        </p>
                        <div className="flex items-center -space-x-2 overflow-hidden">
                            <img src="/src/assets/itsrgpv.jpg" className="w-10 h-10 border-2 border-white rounded-full" />
                            <img src="/src/assets/itsrgpv.jpg" className="w-10 h-10 border-2 border-white rounded-full" />
                            <img src="/src/assets/itsrgpv.jpg" className="w-10 h-10 border-2 border-white rounded-full" />
                            <img src="/src/assets/itsrgpv.jpg" className="w-10 h-10 border-2 border-white rounded-full" />
                            <img src="/src/assets/itsrgpv.jpg" className="w-10 h-10 border-2 border-white rounded-full" />
            ...
            <div className="flex items-center justify-center flex-1 h-screen">
                <div className="max-w-md p-10 rounded-xl space-y-8 border text-white  bg-white/10 w-[600px] sm:px-10 ">
                    <div className="">
                        <img src="/src/assets/itsrgpv.jpg" width={150} className="lg:hidden" />
                        <div className="mt-5 space-y-2">
                            <h3 className="text-2xl font-bold text-white sm:text-3xl">Login</h3>
                            <p className="">Don't have an account? <Link to="/auth" className="font-medium text-indigo-600 hover:text-indigo-500">Sign Up</Link></p>
                        </div>
                    </div>
                    ...
                    <div className="relative">
                        ...
                        <p className="absolute inset-x-0 inline-block px-2 mx-auto text-sm text-black bg-white w-fit -top-2">Or continue with</p>
                    </div>
                    <form
